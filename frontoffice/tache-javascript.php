...
<head>
  ...
  <title>NutriSmart - Tâche 5 — JavaScript</title>
...
<body>
  ...
  <header class="page-header">
    ...
    <h1>Tâche 5 — JavaScript</h1>
    <p class="subtitle">Page réservée au camarade qui travaille sur le JavaScript.</p>
  </header>
  ...
  <main class="container">
    <section class="section">
      <div class="empty-box">
        <h2>Tâche 5 — JavaScript</h2>
        <p>Page réservée au camarade qui travaille sur le JavaScript.</p>
