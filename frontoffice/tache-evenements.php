...
<head>
  ...
  <title>NutriSmart - Tâche 2 — Événements</title>
...
<body>
  ...
  <header class="page-header">
    ...
    <h1>Tâche 2 — Événements</h1>
    <p class="subtitle">Page réservée au camarade qui travaille sur les événements.</p>
  </header>
  ...
  <main class="container">
    <section class="section">
      <div class="empty-box">
        <h2>Tâche 2 — Événements</h2>
        <p>Page réservée au camarade qui travaille sur les événements.</p>
