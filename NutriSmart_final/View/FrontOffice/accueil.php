...
<body class="accueil-body">
  ...
  <nav class="navbar" id="navbar">
    ...
    <div class="nav-links">
      ...
      <a href="index.php?page=dashboard" class="nav-dashboard">Dashboard</a>
    </div>
  </nav>
  ...
  <section class="accueil-hero">
    ...
    <div class="accueil-cta-row">
      <a href="index.php?page=inscription" class="btn-primary-accueil">Voir les utilisateurs</a>
      <a href="index.php?page=dashboard" class="btn-secondary-accueil">Accéder au backoffice</a>
    </div>
