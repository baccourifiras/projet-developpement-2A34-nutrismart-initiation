...
<head>
  ...
  <title>NutriSmart - Tâche 3 — Participants</title>
...
<body>
  ...
  <header class="page-header">
    ...
    <h1>Tâche 3 — Participants</h1>
    <p class="subtitle">Page réservée au camarade qui travaille sur les participants.</p>
  </header>
  ...
  <main class="container">
    <section class="section">
      <div class="empty-box">
        <h2>Tâche 3 — Participants</h2>
        <p>Page réservée au camarade qui travaille sur les participants.</p>
